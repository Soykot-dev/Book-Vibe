        ...
        <div className='flex flex-col md:flex-row md:gap-10 justify-center md:items-center bg-base-200 rounded-lg md:rounded-3xl px-8 md:px-0 py-8 md:py-16'>
            <div className="">
                ...
                <div className="mt-4 md:mt-12">
                    <a href="#_" className="text-white relative inline-flex items-center justify-start px-3 md:px-6 py-2 pt-3 md:pt-4 md:py-4 overflow-hidden font-medium transition-all bg-[#23BE0A] rounded-md group">
